...
namespace WeatherBot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient("weatherBotClient")
                .AddTypedClient<ITelegramBotClient>((httpClient, services)=>
                {
                    ...
                    TelegramBotClient botClient = new TelegramBotClient(
                        new TelegramBotClientOptions(botConfiguration.BotToken), httpClient);
                    return botClient;
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WeatherBot", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WeatherBot v1"));
            }
